# Journal du Mercredi, le 16 Septembre 2026 (rédigé par: Kokou MEGNASSAN)
...
---
- Montage électrique généré :
![image](../medias/IMG_2026_09_16_Circuit-Généré.png)
...
La programmation du XIAO ESP32-S3 est réalisée avec **Thonny** et **MicroPython**.

Un programme `main.py` a été préparé pour :

1. Initialiser le bus I²C.
2. Détecter l'OLED.
3. Détecter le MAX30102.
4. Détecter le QMI8658.
5. Lire le signal IR du MAX30102.
6. Estimer la fréquence cardiaque en BPM.
7. Lire les mouvements avec le QMI8658.
8. Afficher les informations sur l'OLED.
9. Afficher les données dans la console de Thonny.
10. Prévoir une alerte avec le buzzer optionnel.
